...
export default function DepthFooterWrapper({ contactId = 'contact' }: DepthFooterWrapperProps) {
  ...
  // Track scroll progress across a generous scroll distance runway
  ...
  // 2-Point continuous mathematical mapping [0, 1] - eliminates piecewise animation stop jumps!
  ...
  return (
    <div 
      ref={containerRef} 
      className="relative w-full min-h-[180vh] bg-slate-950 text-white"
    >
